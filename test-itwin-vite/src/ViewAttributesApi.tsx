...
export type ViewFlag = keyof Pick<
  ViewFlagsProperties,
  | "acsTriad"
  | "backgroundMap"
  | "grid"
...
export class ViewAttributesApi {
  ...
  public static getBackgroundTransparency(vp: Viewport) {
    return vp.backgroundMapSettings.transparency === false
      ? 1
      : vp.backgroundMapSettings.transparency;
  }
  ...
  public static setCameraOnOff(vp: Viewport, on: boolean) {
    if (on) vp.turnCameraOn();
    else (vp.view as ViewState3d).turnCameraOff();
